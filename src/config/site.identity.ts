export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'kireso',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Kireso',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'kireso.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://kireso.com',
